...
import useFetch from "../../hooks/camping";
  ...
  const handleClick = async (e) => {
    ...
    if (typeof rooms === 'string') {
      ...
      try {
        ...
        await axios.post(`/rooms/${hotelId}`, { ...info,photos: list, roomNumbers, namek: user.username, type: "camping" });

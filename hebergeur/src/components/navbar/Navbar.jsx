...
const Navbar = () => {
  ...
  useEffect(() => {
    async function fetchNotificationCount() {
      try {
        const response = await fetch(`/notification/sum/${user.username}`); // Assuming user.id is the 'to' parameter
    ...
    <div className="navbar">
      <div className="wrapper">
        ...
        <div className="items">
          ...
          <div className="item">
          <img className="avatar" src={user.img || "https://i.ibb.co/MBtjqXQ/no-avatar.gif"} alt="avatar" />
